 ...
 * @flags: Active flags accumulator
...
/**
 * print_string - Outputs a sequence of characters
 * @types: Argument list
 * @buffer: Array buffer for display
 * @flags: Active flags accumulator
...
/**
 * print_percent - Outputs the percentage symbol
 * @types: Argument list
 * @buffer: Array buffer for display
 * @flags: Active flags accumulator
...
/**
 * print_binary - Outputs binary format of an unsigned number
 * @types: Argument list
 * @buffer: Array buffer for display
 * @flags: Active flags accumulator
 * @width: Width specification
