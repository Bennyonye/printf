...
/* ==================== PRINT NON PRINTABLE ===================== */
/**
 * print_non_printable - Shows ascii codes in hex of non-printable chars
 * @types: List of arguments
 * @buffer: Buffer array for print handling
 * @flags:  Determines active flags
 * @width: Specifies width
...
/* ======================= PRINT REVERSE ======================== */
/**
 * print_reverse - Displays a string in reverse order
 * @types: List of arguments
 * @buffer: Buffer array for print handling
 * @flags:  Determines active flags
 * @width: Specifies width
...
/**
 * print_rot13string - Displays a string using rot13 cipher
 * @types: List of arguments
 * @buffer: Buffer array for print handling
 * @flags:  Determines active flags
 * @width: Specifies width
